...
import com.wy.arialena.modulecore.update_app.UpdateAppBean;
...
//                intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_PERSISTABLE_URI_PERMISSION);
                ...
                Uri fileUri = FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".downFileProvider", appFile);
