package com.wy.arialena.modulecore.widget.timepick.popup;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int topLineColor = 0xFFE2E4EA;
    ...
    protected int submitTextColor = 0xFF22B14C;
    protected int titleTextColor = Color.BLACK;
    protected int pressedTextColor = 0XFF22B14C;
