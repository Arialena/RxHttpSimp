...
import com.wy.arialena.modulecore.utils.NetUtil;
...
public class PhoneInfoHelper {
    ...
    // 获取当前正在运行的非系统应用
    public static ArrayList<String> getTaskApks(Context context) {
     ...
     * @return 应用程序的集合
     */
    public static List<String> getMyAllApps(Context context) {
     ...
     * @return
     */
    public static String getTimeForFeeInfo() {
        Date date = new Date();
     ...
     * 获取当前应用的版本
     */
    public static String getCurronProgramVer(Context context) {
        String currVer = "";
        try {
     ...
     * @return
     */
    public static String getProvidersStr(Context context) {
        TelephonyManager telephonyManager = (TelephonyManager) context
                .getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String hmacSign(String body, String appKey) {
