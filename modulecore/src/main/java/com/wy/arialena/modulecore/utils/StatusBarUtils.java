...
import com.wy.arialena.modulecore.widget.titleBar.TitleBar;
...
public class StatusBarUtils {
    ...
    public static void immersiveStatusBar(Activity activity, TitleBar titleBar, @FloatRange(from = 0.0, to = 1.0) float alpha) {
        ...
        if (titleBar != null){
            titleBar.setPadding(0,getStatusBarHeight(activity),0,0);
        }
