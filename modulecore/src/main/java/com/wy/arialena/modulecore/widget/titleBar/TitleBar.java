...
import com.wy.arialena.modulecore.widget.titleBar.style.BaseTitleBarStyle;
import com.wy.arialena.modulecore.widget.titleBar.style.TitleBarLightStyle;
import com.wy.arialena.modulecore.widget.titleBar.style.TitleBarNightStyle;
import com.wy.arialena.modulecore.widget.titleBar.style.TitleBarRippleStyle;
import com.wy.arialena.modulecore.widget.titleBar.style.TitleBarTransparentStyle;
...
public final class TitleBar extends FrameLayout
    ...
    public TitleBar setLeftClickLisenter(boolean b){
        if (mLeftView != null){
            mLeftView.setClickable(b);
            mLeftView.setEnabled(b);
        }
        return this;
    }

    public TitleBar setRightClickLisenter(boolean b){
        if (mRightView != null){
            mRightView.setClickable(b);
            mRightView.setEnabled(b);
        }
        return this;
    }
